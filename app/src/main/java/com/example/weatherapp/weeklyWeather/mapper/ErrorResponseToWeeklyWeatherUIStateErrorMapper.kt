...
import com.example.weatherapp.weeklyWeather.uiState.WeeklyWeatherUIState.Error

class ErrorResponseToWeeklyWeatherUIStateErrorMapper : Mapper<ErrorResponse, Error> {
