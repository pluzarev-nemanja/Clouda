...
class ErrorResponseToWeeklyWeatherUIStateErrorMapper : Mapper<ErrorResponse, WeeklyWeatherUIState> {

    override fun mappingObjects(input: ErrorResponse): WeeklyWeatherUIState =
        when (input) {
